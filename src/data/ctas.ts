...
export const categoryCTAs: CategoryCTA[] = [
  {
    ...
    text: 'LifeHQ includes a complete capture and processing system in Obsidian — so you never lose track of valuable information again.',
  ...
  },
  {
    ...
    text: 'LifeHQ gives you a linked idea management system in Obsidian — connecting your notes so great ideas never get lost.',
    buttonLabel: 'Learn More About LifeHQ',
    url: 'https://lifehq.practicalpkm.com',
  },
  {
    ...
    text: 'LifeHQ includes a complete task and project management system in Obsidian — with weekly reviews, priorities, and next actions built in.',
    buttonLabel: 'Learn More About LifeHQ',
    url: 'https://lifehq.practicalpkm.com',
  },
  {
    ...
    text: 'LifeHQ includes vision, values, and goal-setting templates in Obsidian — so you can make decisions with clarity and purpose.',
    buttonLabel: 'Learn More About LifeHQ',
    url: 'https://lifehq.practicalpkm.com',
  },
  {
    ...
    text: 'LifeHQ includes daily, weekly, and quarterly review templates in Obsidian — turning journaling into a consistent, high-leverage habit.',
    buttonLabel: 'Learn More About LifeHQ',
    url: 'https://lifehq.practicalpkm.com',
  },
];
